...
export class RegistryProvider implements Disposable {
    ...
    private getUserRegistryConfig(): UserRegistry[] {
        ...
        assertType(
            ...
            localize('user.setting.invalid', 'com-appalachia-vscode-extension-manager.registries setting is invalid'),
        );
    ...
    private onDidChangeConfiguration(e: vscode.ConfigurationChangeEvent) {
        if (
            e.affectsConfiguration('com-appalachia-vscode-extension-manager.registries') ||
            e.affectsConfiguration('com-appalachia-vscode-extension-manager.channels')
        ) {
            this.isStale = true;
            this._onDidChangeRegistries.fire();
        }
