...
export class ShowExtensionCommand implements Command {
    public readonly id = 'appaExtensionManager.extension.show';
...
export class InstallExtensionCommand implements Command {
    public readonly id = 'appaExtensionManager.extension.install';
...
export class UpdateExtensionCommand implements Command {
    public readonly id = 'appaExtensionManager.extension.update';
...
export class UninstallExtensionCommand implements Command {
    public readonly id = 'appaExtensionManager.extension.uninstall';
...
export class InstallAnotherVersionCommand implements Command {
    public readonly id = 'appaExtensionManager.extension.install.anotherVersion';
...
export class SwitchChannelsCommand implements Command {
    public readonly id = 'appaExtensionManager.extension.switchChannels';
...
export class CopyExtensionInformationCommand implements Command {
    public readonly id = 'appaExtensionManager.extension.copyInformation';
