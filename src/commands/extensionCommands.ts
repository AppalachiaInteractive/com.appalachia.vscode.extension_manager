...
export class ShowExtensionCommand implements Command {
    public readonly id = 'appa-extension-manager.extension.show';
...
export class InstallExtensionCommand implements Command {
    public readonly id = 'appa-extension-manager.extension.install';
...
export class UpdateExtensionCommand implements Command {
    public readonly id = 'appa-extension-manager.extension.update';
...
export class UninstallExtensionCommand implements Command {
    public readonly id = 'appa-extension-manager.extension.uninstall';
...
export class InstallAnotherVersionCommand implements Command {
    public readonly id = 'appa-extension-manager.extension.install.anotherVersion';
...
export class SwitchChannelsCommand implements Command {
    public readonly id = 'appa-extension-manager.extension.switchChannels';
...
export class CopyExtensionInformationCommand implements Command {
    public readonly id = 'appa-extension-manager.extension.copyInformation';
