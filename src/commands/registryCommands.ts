...
export class AddUserRegistryCommand implements Command {
    public readonly id = 'com-appalachia-vscode-extension-manager.registry.add';
    ...
    public async execute(): Promise<void> {
        ...
        await vscode.window.showInformationMessage(
            localize(
                'registry.added',
                'Registry "{0}" added. {1} and edit "com-appalachia-vscode-extension-manager.registries" to configure authentication or other settings.',
                name,
                settingsJsonLink,
            ),
        );
...
export class RemoveUserRegistryCommand implements Command {
    public readonly id = 'com-appalachia-vscode-extension-manager.registry.remove';
