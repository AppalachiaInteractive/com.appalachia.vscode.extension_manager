...
open with the `appaExtensionManager.registries` setting. This has the same format
...
You can manually select channels with the `appaExtensionManager.channels` settings
...
disable it with the `appaExtensionManager.updateCheckInterval` setting.
